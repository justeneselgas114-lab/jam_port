  ...
  <section id="expertise" className="py-20 sm:py-32 px-4 sm:px-6 relative">
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
        {SKILLS.map((item, idx) => (
          <div key={idx} className="glass-card p-8 rounded-[2.5rem] border-white/5 hover:border-blue-500/50 transition-all duration-500 group hover:-translate-y-2 h-full flex flex-col">
